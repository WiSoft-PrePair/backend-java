...
public class JobPostingService {
    ...
    public JobPosting crawlAndSave(final String url) {
        final Optional<JobPosting> existing = jobPostingRepository.findBySourceUrl(url);
        ...
        final String content = openAiClient.chat(STRUCTURING_PROMPT, rawContent);
        final SourceType sourceType = crawler.supportedSite();
        final JobPosting jobPosting = new JobPosting(url, sourceType, content, rawContent);
