package io.wisoft.prepair.prepair_api.interview.question.repository;
...
public interface QuestionRepository extends JpaRepository<InterviewQuestion, UUID> {
    ...
    @Query("UPDATE InterviewQuestion q SET q.latestScore = :score " +
           ...
           "AND q.questionType = io.wisoft.prepair.prepair_api.interview.question.entity.QuestionType.TEXT " +
